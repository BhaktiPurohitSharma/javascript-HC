...
const newArr1=marvel_heros1.concat(dc_heros1); 
//concat two array
//does not change original aaray only add new array at end of array
...
console.log(Array.from({name:"Bhakti"})); //otput:[] //if cant able to convert in array it gives empty array
